...
- `c5_convergence_status`: `ELIGIBLE / NOT STARTED` (C4 gate review 后才开始; D2, R3-full, R4, V5-2+ 继续 LOCKED)
...
- `last_independently_verified_semantic_subject_commit`: `1d7b59c` (C4 transport cutover subject)
...
- The current execution baseline is D-015 plus `docs/plans/v5-architecture-convergence.md` and the
  ...
  convergence gate releases them. C0–C4 closed (`903e954`, `3dc7339`, `d2c3f18`, `3adaac0`, `1d7b59c`; verifier PASS); C5 is `ELIGIBLE / NOT STARTED`.
...
C0–C4 architecture convergence waves are closed (`903e954`, `3dc7339`, `d2c3f18`, `3adaac0`, `1d7b59c`; verifier
PASS P0=0/P1=0); C5 is `ELIGIBLE / NOT STARTED`. R1/R2 semantic subjects are
