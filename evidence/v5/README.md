...
| V5-R4 First System Case | [`r4firstcase_20260812T072114Z_365c2c8`](stage-1/first-system-case/r4firstcase_20260812T072114Z_365c2c8/) | `PASS (contract + R4 replay)` | `365c2c8` | 5×1C intent 激活；source→case→bind→propose→confirm；readiness 界限 PENDING_MATERIALIZATION；PG journey 全过；live facets `NOT_RUN` |
