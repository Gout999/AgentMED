...
开始任何工作前，先读 [产品原则](../docs/product-principles.md)、[仓库工程规则](../AGENTS.md) 和任务涉及的正式 plan。当前 Wiki 同时保留 v3 客服参考纵切的已实现/历史知识，并蒸馏已批准的 v4 施工路线；不能把目标架构、参考场景、研究结论或历史比赛叙事写成已经实现的通用能力。
...
2. **施工目标与依赖顺序**：[plan-v4](../docs/plan-v4.md) 是已批准的 v4 施工基线；路线获批不等于功能已经实现。
