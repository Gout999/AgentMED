...
# activated by-id GET/action operations exist today; the frozen schema
    ...
    return {
        ...
        "info": {
            ...
            "description": (
                ...
                "FROZEN_R2_R3_BOOTSTRAP / FROZEN_R3 / FROZEN_R4 intents from "
                "the intent registry); draft and deferred intents never "
                "generate paths. "
