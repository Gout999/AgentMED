...
class IdempotencyResource(WireModel):
    kind: Literal[
        "signal", "source_sync_run", "automation_request", "approval_grant", "external_operation"
    ]
...
class IdempotencyReceipt(WireModel):
    ...
    def intent_binding_is_exact(self) -> "IdempotencyReceipt":
        ...
        expected: dict[str, tuple[str, str, bool, str]] = {
            ...
            "sources.doctor": ("source_sync_run", "ssr_", True, "ACCEPTED"),
            "investigations.start": ("automation_request", "arq_", True, "ACCEPTED"),
            "work.stop-request": ("automation_request", "arq_", True, "ACCEPTED"),
            "approvals.decide": ("approval_grant", "appr_", False, "COMPLETED"),
            "releases.rollback-request": ("external_operation", "eop_", True, "ACCEPTED"),
        }
